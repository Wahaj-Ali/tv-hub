...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\r\n\r\nfunction searchShow(query) {\r\n    const url = `https://api.tvmaze.com/shows/${query}`;\r\n    fetch(url).then(response => response.json())\r\n    // .then(json => console.log(json))\r\n  .then(json => console.log(json.name,json.rating,json.genres,json.image));\r\n}\r\nsearchShow(3);\r\n\r\nconst displayShows = (shows) => {\r\n    const showsList = document.querySelector('.showslist');\r\n    showsList.innerHTML = '';\r\n    shows.forEach((show) => {\r\n      const inddividualShow = `<div class=\"individual-show\">${show.name}</div>`;\r\n      showsList.innerHTML += inddividualShow;\r\n    });\r\n  };\r\n\r\n  window.onload = searchShow(2).then((data) => displayShows(data.name));\n\n//# sourceURL=webpack://tv-hub/./src/index.js?");
